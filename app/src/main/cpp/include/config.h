...
#define FFMPEG_CONFIGURATION "--prefix=./android/armeabi-v7a --disable-x86asm --disable-encoders --disable-decoders --disable-avdevice --disable-doc --disable-ffplay --disable-network --disable-doc --disable-symver --enable-neon --enable-gpl --enable-pic --enable-jni --enable-pthreads --enable-mediacodec --enable-encoder=aac --enable-encoder=gif --enable-encoder=libopenjpeg --enable-encoder=libmp3lame --enable-encoder=libwavpack --enable-encoder=mpeg4 --enable-encoder=pcm_s16le --enable-encoder=png --enable-encoder=srt --enable-encoder=subrip --enable-encoder=yuv4 --enable-encoder=text --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=libopenjpeg --enable-decoder=mp3 --enable-decoder=mpeg4_mediacodec --enable-decoder=pcm_s16le --enable-decoder=flac --enable-decoder=flv --enable-decoder=gif --enable-decoder=png --enable-decoder=srt --enable-decoder=xsub --enable-decoder=yuv4 --enable-decoder=vp8_mediacodec --enable-bsf=h264_mp4toannexb --enable-bsf=hevc_mp4toannexb --enable-bsf=mpeg4_unpack_bframes --enable-cross-compile --cross-prefix=/Users/xiaoyunfei/Library/Android/ndk-r17/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --enable-shared --enable-small --disable-static --sysroot=/Users/xiaoyunfei/Library/Android/ndk-r17/platforms/android-16/arch-arm --extra-cflags='-U_FILE_OFFSET_BITS -isystem /Users/xiaoyunfei/Library/Android/ndk-r17/sysroot/usr/include/arm-linux-androideabi -D__ANDROID_API__=16 -g -DANDROID -ffunction-sections -funwind-tables -fstack-protector-strong -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -mthumb -Wa,--noexecstack -Wformat -Werror=format-security -std=c++11 -O0 -fPIC -isystem /Users/xiaoyunfei/Library/Android/ndk-r17/sources/cxx-stl/llvm-libc++/include -isystem /Users/xiaoyunfei/Library/Android/ndk-r17/sources/android/support/include -isystem /Users/xiaoyunfei/Library/Android/ndk-r17/sources/cxx-stl/llvm-libc++abi/include' --extra-cflags='-isysroot /Users/xiaoyunfei/Library/Android/ndk-r17/sysroot' --arch=arm --target-os=android"
